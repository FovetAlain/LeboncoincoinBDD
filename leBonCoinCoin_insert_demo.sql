...
insert into locataires values(NULL,'jojo','DuGlan','Johnathan','jojo.duglan@chapo.tu');
insert into locataires values(NULL,'jojo1','DuGlan','Johnathan1','jojo1.duglan1@chapo.tu');
insert into locataires values(NULL,'jojo2','DuGlan','John','jojo2.duglan@chapo.tu');
insert into locataires values(NULL,'jojo3','DuGlan','Johna','jojo3.duglan@chapo.tu');
insert into locataires values(NULL,'jojo4','DuGlan','Johnat','jojo4.duglan@chapo.tu');
insert into locataires values(NULL,'jojo5','DuGlan','Johnath','jojo5.duglan@chapo.tu');
insert into locataires values(NULL,'jojo6','DuGlan','Johnatha','jojo6.duglan@chapo.tu');
insert into locataires values(NULL,'jojo7','DuGlan','Johnathan','jojo7.duglan@chapo.tu');
insert into locataires values(NULL,'jojo8','DuGlan','John','jojo8.duglan@chapo.tu');
insert into locataires values(NULL,'jojo9','DuGlan','Johnathan','jojo9.duglan@chapo.tu');
insert into locataires values(NULL,'jojo10','DuGlan','Johnathan10','jojo10.duglan@chapo.tu');
insert into locataires values(NULL,'jojo11','DuGlan','Johnathan11','jojo11.duglan@chapo.tu');
insert into locataires values(NULL,'jojo12','DuGlan','Johnathan12','jojo12.duglan@chapo.tu');
insert into locataires values(NULL,'jojo13','DuGlan','Johnathan13','jojo13.duglan@chapo.tu');
insert into locataires values(NULL,'jojo14','DuGlan','Johnathan14','jojo14.duglan@chapo.tu');
insert into locataires values(NULL,'jojo15','DuGlan','Johnathan15','jojo15.duglan@chapo.tu');
insert into locataires values(NULL,'jojo16','DuGlan','Johnathan16','jojo16.duglan@chapo.tu');
insert into locataires values(NULL,'jojo17','DuGlan','Johnathan17','jojo17.duglan@chapo.tu');
insert into locataires values(NULL,'jojo18','DuGlan','Johnathan18','jojo18.duglan@chapo.tu');
insert into locataires values(NULL,'jojo19','DuGlan','Johnathan19','jojo19.duglan@chapo.tu');
...
insert into foyer values(1,1);
insert into foyer values(1,2);
insert into foyer values(2,3);
insert into foyer values(2,4);
insert into foyer values(3,5);
insert into foyer values(3,6);
insert into foyer values(4,7);
insert into foyer values(4,8);
insert into foyer values(5,9);
insert into foyer values(5,10);
insert into foyer values(6,11);
insert into foyer values(6,12);
insert into foyer values(7,13);
insert into foyer values(7,14);
insert into foyer values(8,15);
insert into foyer values(9,16);
insert into foyer values(10,17);
insert into foyer values(10,18);
insert into foyer values(10,19);
